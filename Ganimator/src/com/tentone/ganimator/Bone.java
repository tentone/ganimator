...
public class Bone
{
	...
	{
		sprite.setPosition(buffer_frame.pos.x*animation.getScale()+animation.getPosition().x, buffer_frame.pos.y*animation.getScale()+animation.getPosition().y);
		sprite.setSize(buffer_frame.size.x*animation.getScale(),buffer_frame.size.y*animation.getScale());
