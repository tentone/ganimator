...
public class Interface extends javax.swing.JFrame
{
    ...
    private void time_sliderPropertyChange(java.beans.PropertyChangeEvent evt) {                                           
        //Time slider prop change
        Ganimator.setAnimationTime(getTimeBarTime());
    }                                          

    private void new_size_xActionPerformed(java.awt.event.ActionEvent evt) {                                           
        // TODO add your handling code here:
    }                                          

    private void bone_loop_modeActionPerformed(java.awt.event.ActionEvent evt) {                                               
    ...
    private void new_addActionPerformed(java.awt.event.ActionEvent evt) {                                        
    ...
    private void new_labelActionPerformed(java.awt.event.ActionEvent evt) {                                          
        // TODO add your handling code here:
    }                                         

    private void bone_deleteActionPerformed(java.awt.event.ActionEvent evt) {                                            
    ...
    private void bone_edit_frame_okActionPerformed(java.awt.event.ActionEvent evt) {                                                   
    ...
    private void menu_settingsActionPerformed(java.awt.event.ActionEvent evt) {                                              
        //Menu Settigs
        updateSettingsFrame();
    ...
    private void settings_frame_okActionPerformed(java.awt.event.ActionEvent evt) {                                                  
    ...
    private void texture_directorie_changeActionPerformed(java.awt.event.ActionEvent evt) {                                                          
    ...
    private void bone_editActionPerformed(java.awt.event.ActionEvent evt) {                                          
        //Edit Selected Bone
    ...
    private void menu_editor_aboutActionPerformed(java.awt.event.ActionEvent evt) {                                                  
        //Show About Window
    ...
    private void animation_speedPropertyChange(java.beans.PropertyChangeEvent evt) {                                               

    }                                              

    private void menu_export_image_sequenceActionPerformed(java.awt.event.ActionEvent evt) {                                                           
        //Export Image Menu Option
        export_image_sequence_frame.setVisible(true);
    }                                                          

    private void frame_deleteActionPerformed(java.awt.event.ActionEvent evt) {                                             
        //Delete Frame
        if(!Ganimator.bone_selected || Ganimator.working_bone.length!=1)
        {
    ...
    private void add_frame_addActionPerformed(java.awt.event.ActionEvent evt) {                                              
    ...
    private void add_frame_timeKeyPressed(java.awt.event.KeyEvent evt) {                                          
    ...
    private void edit_size_xActionPerformed(java.awt.event.ActionEvent evt) {                                            

    }                                           

    private void edit_cancelActionPerformed(java.awt.event.ActionEvent evt) {                                            
       frame_edit_frame.setVisible(false);
       this.setEnabled(true);
       this.requestFocus();
    }                                           

    private void edit_okayActionPerformed(java.awt.event.ActionEvent evt) {                                          
    ...
    private void bone_upActionPerformed(java.awt.event.ActionEvent evt) {                                        
        //Move Bone Up
        if(!Ganimator.bone_selected || Ganimator.working_bone.length!=1)
        {
            JOptionPane.showMessageDialog(null, "Select One Bone First!");
    ...
    private void bone_downActionPerformed(java.awt.event.ActionEvent evt) {                                          
        //Move Bone Down
        if(!Ganimator.bone_selected || Ganimator.working_bone.length!=1)
        {
            JOptionPane.showMessageDialog(null, "Select One Bone First!");
    ...
    private void about_frameComponentShown(java.awt.event.ComponentEvent evt) {                                           
        // TODO add your handling code here:
    }                                          

    private void settings_fps_lockActionPerformed(java.awt.event.ActionEvent evt) {                                                  
    ...
    private void working_bone_selectorValueChanged(javax.swing.event.ListSelectionEvent evt) {                                                   
    ...
    private void about_frameWindowClosing(java.awt.event.WindowEvent evt) {                                          
        about_frame.setVisible(false);
        this.setEnabled(true);
        this.requestFocus();
    }                                         

    private void frame_selectorValueChanged(javax.swing.event.ListSelectionEvent evt) {                                            
    ...
    private void explorer_positionActionPerformed(java.awt.event.ActionEvent evt) {                                                  
    ...
    private void texture_directorieActionPerformed(java.awt.event.ActionEvent evt) {                                                   
        // TODO add your handling code here:
    }                                                  

    private void dialog_noActionPerformed(java.awt.event.ActionEvent evt) {                                          
        // TODO add your handling code here:
    }                                         

    private void animation_speedStateChanged(javax.swing.event.ChangeEvent evt) {                                             
    ...
    private void bone_edit1ActionPerformed(java.awt.event.ActionEvent evt) {                                           
        //Clone Selected Bone
        if(working_bone_selector.getSelectedIndex()!=-1)
        {
