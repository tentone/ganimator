...
public class Animation
{
	...
	private Vector2 pos; //Animation Position
	private float scale; //Animation Size Scale
	private TextureManager texture_manager; //Animation Texture Manager
	...
	//Clone Bone to animation created external
	public void cloneBone(int index)
	{
